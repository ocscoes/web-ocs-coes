...
subtitle: Primera nota OCS sobre investigación de cohesión social
categories: [blog]
# Date published
...
1. **Seguridad barrial**:  De acuerdo con la @fig-1, mientras un 37,2% percibe su barrio como seguro de manera estable, otro 25,3% se ha vuelto más incierto en su percepción, y un 19,9% considera que vive en un entorno derechamente inseguro.

```{r}
#| label: fig-1
#| fig-cap-location: top
#| fig-cap: "Percepción de seguridad en el barrio"
#| fig-align: center
#| out-width: '100%'
library(knitr)
library(here)

knitr::include_graphics(path = here("noticias/posts/nota-dm/fig1.png"))

```



2. **Confianza social generalizada**: En la @fig-2 se observa que la postura dominante es de desconfianza (42,5%), estable en el tiempo. Solo un 10,4% confía en los demás, con un alza puntual en 2019, coincidiendo con el estallido social.

```{r}
#| label: fig-2
#| fig-cap-location: top
#| fig-cap: "Confianza social generalizada"
#| fig-align: center
#| out-width: '100%'
library(knitr)
library(here)

knitr::include_graphics(path = here("noticias/posts/nota-dm/fig2.png"))

```


- **Justicia distributiva**: Según la @fig-3, un 26% muestra una preferencia estable por la equidad, mientras un 22,6% pasó de niveles altos a moderados en los últimos años.

```{r}
#| label: fig-3
#| fig-cap-location: top
#| fig-cap: "Indicador de preferencia por justicia distributiva en salud, pensiones y educación"
#| fig-align: center
#| out-width: '100%'
library(knitr)
library(here)

knitr::include_graphics(path = here("noticias/posts/nota-dm/fig3.png"))
...
![](daniel_miranda.png){.center width=300px height=300px}
