...
<div class="layout">
  <article>
    <div class="img-container">
      <img class="lukas" src="imagenes/jc-foro3.jpg" data-url="noticias/posts/post-tercer-foro/">
      <div class="overlay-text">Cohesión social en tiempos de desafección política en la XII Conferencia Internacional COES. Click para más información</div>
    </div>
    <div class="img-container">
      <img class="lukas" src="imagenes/columna-tercera.png" data-url="noticias/posts/columna-tercera-dosis/">
      <div class="overlay-text">Columna de opinión del IP Juan Carlos Castillo y AI René Canales cohesión social y seguridad pública. Click para más información</div>
    </div>
  </article>
</div>
...
<div class="wrap">
  <!-- Tile 1 -->
  <a href="https://gabrielcortesp.shinyapps.io/visualizador-la/">
    <div class="tile">
      <img src="/imagenes/vis-latam.png" alt="OCSVIS-LA" style="width: 100%;" />
      <div class="text">
  ...
  <!-- Tile 2 (nuevo) -->
<a href="https://ocs-coes.shinyapps.io/ocs-viselsoc/">
    <div class="tile">
      <img src="/imagenes/vis-elsoc.png" alt="OCSVIS-ELSOC" style="width: 100%;" />
      <div class="text">
        <h1>Visualizador de Cohesión Social en Chile</h1>
        <div class="highlight-box">
          <p class="animate-text">Indicadores de Cohesión Social basados en la encuesta ELSOC.</p>
        </div>
      </div>
    </div>
  </a>
...
::: {.button}
[Noticias anteriores](noticias/index.qmd){.btn-action-primary .btn-action .btn .btn-success .btn-lg role="button" style="background-color: #0693e3; margin-top: 0em;"}
:::
...
<p align="center" style="font-size:36px; font-weight:bold;">
<i class="bi bi-people-fill" style="margin-right: 10px;"></i>Integrantes</p>
...
::: {.button}
[Pasaron por OCS](alumni/index.qmd){.btn-action-primary .btn-action .btn .btn-success .btn-lg role="button" style="background-color: #0693e3; margin-top: 0em;"}
:::
